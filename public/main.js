...
/***/ function(module, exports, __webpack_require__) {
	...
	var App, DefaultRoute, Game, Link, NotFoundRoute, React, Redirect, Route, RouteHandler, Router, routes;

	React = __webpack_require__(1);

	Router = __webpack_require__(157);

	Redirect = Router.Redirect, Route = Router.Route, RouteHandler = Router.RouteHandler, Link = Router.Link, DefaultRoute = Router.DefaultRoute, NotFoundRoute = Router.NotFoundRoute;

	App = __webpack_require__(196);

	Game = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game = React.createClass({
	  ...
	  getInitialState: (function(_this) {
	    return function() {
	      return {
	  ...
	  componentWillMount: (function(_this) {
	    return function() {
	      return console.log('Will Mount...');
	    };
	  })(this),
	  componentDidMount: (function(_this) {
	    return function() {
